    ...
    if (decision.isDenied()) {
        if (decision.reason.isRateLimit()) {
            ...
            if (decision.reason.emailTypes.includes("INVALID")) {
                message = "Le format de l'adresse e-mail n'est pas valide. Y a-t-il une faute de frappe ?";
            } else if (decision.reason.emailTypes.includes("DISPOSABLE")) {
                message = "Nous n'autorisons pas les adresses e-mail jetables.";
            } else if (decision.reason.emailTypes.includes("NO_MX_RECORDS")) {
                message =
                    "Votre domaine de messagerie électronique ne dispose pas d'enregistrement MX. Y a-t-il une faute de frappe ?";
            } else {
